<script>
	...
	const isExpanded = (index) => expandedQuestion === index;
</script>
...
<section class="landing-page-section">
	...
	<div class="faq-container">
		{#each faqs as faq, index}
			<FaqItem {faq} isExpanded={isExpanded(index)} onclick={() => handleClick(index)} />
		{/each}
	</div>
	...
	<div class="additional-info mt-m">
		...
		<a href="https://twitter.com/jacobleesinger">
			<p>Hit me up on Twitter <img class="twitter-icon" src={twitterIcon} alt="Twitter Icon" /></p>
		</a>
	</div>
</section>
